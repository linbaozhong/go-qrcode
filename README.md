...
## Install
    ...
    go get -u github.com/linbaozhong/go-qrcode/...

A command-line tool `qrcode` will be built into `$GOPATH/bin/`.

## Usage

    import qrcode "github.com/linbaozhong/go-qrcode"
...
[![godoc](https://godoc.org/github.com/linbaozhong/go-qrcode?status.png)](https://godoc.org/github.com/linbaozhong/go-qrcode)
...
https://github.com/linbaozhong/go-qrcode
...
Usage:
  ...
  2. Save to file if "display" not available:
       ...
       qrcode "homepage: https://github.com/linbaozhong/go-qrcode" > out.png
